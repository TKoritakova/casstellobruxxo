...
const Arashar = () => (
  <div>
    ...
    <p>Do kmene Arashar patří studenti, kterým plod ze stromu Umamiri chutná sladce. Tito studenti bývají zvídaví,
      učenliví a zaměření na hlubší pochopení magie samotné. Často se věnují oborům jako jsou magická historie, teorie
      kouzel nebo alchymie. Jejich myšlení je strukturované, milují poznání a experimentování. V komunitě jsou
      považováni za přirozené vizionáře.</p>
    ...
    <p>Školní uniformy tohoto kmene, hlavně jejich slavnostní verze, mohou být doplněny o ozdoby, na základě kterých lze
      studenty náležící danému kmeni jednoznačně poznat. Arasharu náleží růžové a zelené ozdoby.</p>
    ...
    <p>Kmen Arashar sídlí ve vyšších patrech hlavní budovy. Jejich prostory zdobí reliéfy hvězd a historických symbolů a
      světlo sem proniká přes barevná sklíčka, která vrhají duhové obrazce. Studenti spí v menších oddělených zónách a
      mají k dispozici alchymistickou laboratoř i observatoř, jejíž strop se otevírá k hvězdám. Prostředí je tiché a
      studijní, ideální pro teoretiky a experimentátory.</p>
