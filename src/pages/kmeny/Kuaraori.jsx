...
const Kuaraori = () => (
  ...
  <KmenyNav />
    ...
    <p>Do kmene Kuaraori patří studenti, kterým plod ze stromu Umamiri chutná hořce. Tito studenti mají silně vyvinutý smysl pro introspekci a vnitřní svět. Jsou to samotáři, kteří čerpají sílu ze sebekázně, ticha a pozorování. Jejich magie bývá hluboká, emocionálně náročná a často směřuje k oblastem, jako jsou stará zaklínadla, rituální magie nebo práce se sny a podvědomím.</p>
    ...
    <p>Školní uniformy tohoto kmene, hlavně jejich slavnostní verze, mohou být doplněny o ozdoby, na základě kterých lze studenty náležící danému kmeni jednoznačně poznat. Kuaraori náleží žluté a oranžové ozdoby.</p>
    ...
    <p>Kmen Kuaraori má své zázemí v podzemních částech školy, kde prorůstají mohutné kořeny pralesních stromů. Jejich prostory jsou potemnělé, porostlé mechem a osvětlené pouze bioluminiscenčními houbami. Ložnice připomínají malé nory oddělené liánami a kouzelně odhlučněné, aby poskytovaly klid k introspekci. Tento kmen má i svou „jeskyni snů“, sloužící k meditacím a rituálům. Prostředí je tajemné a zaměřené na duchovní hloubku.</p>
