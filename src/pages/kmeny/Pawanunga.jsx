...
const Pawanunga = () => (
  <div>
    ...
    <p>Do kmene Pawanunga patří studenti, kterým plod ze stromu Umamiri chutná slaně. Sdružuje studenty prakticky
      založené, kteří si cení efektivity, disciplíny a silné vůle. Jsou to budoucí obránci magického světa — výborní v
      obranné magii, tvorbě ochranných artefaktů nebo práci se složitými rituály. Bývají přímí, často přísní, ale vždy
      loajální.</p>
    ...
    <p>Školní uniformy tohoto kmene, hlavně jejich slavnostní verze, mohou být doplněny o ozdoby, na základě kterých lze
      studenty náležící danému kmeni jednoznačně poznat. Kuaraori náleží hnědé a červené ozdoby.</p>
    ...
    <p>Kmen Pawanunga obývá spodní patra hlavní budovy, nedaleko výcvikových pavilonů. Jejich síně působí stroze a
      účelně, na podlahách jsou vyznačeny rituální kruhy a lůžka tvoří kovové postele rozdělené podle ročníků. Kmen má
      vlastní dvůr určený k tréninku obranné a útočné magie, jehož zdi pokrývají štíty a ochranné totemy. Atmosféra je
      disciplinovaná a vojensky laděná.</p>
