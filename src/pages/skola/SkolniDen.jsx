...
const SkolniDen = () => (
  <div>
    ...
    <img src={ranni_horizont} className='img-in-text' />
    <img src={hamaka} className='img-in-text' />
    ...
    <img src={nocni_obloha} className='img-in-text' />
    <img src={random_typek} className='img-in-text' />
    ...
    <img src={wayusa_napoj} className='img-in-text' />
    <img src={vyprava} className='img-in-text' />
