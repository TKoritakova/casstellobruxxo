...
const LuanaMarianaAlmeidaSoares = () => (
  <div>
      ...
      <hr/>
      <p><span className='text-highlighter'>Faceclaim:</span> Sydney Taylor</p>
      <p><span className='text-highlighter'>Výška:</span> 163 cm</p>
      <p><span className='text-highlighter'>Váha:</span> 50 kg</p>
      <p><span className='text-highlighter'>Barva očí:</span> Modrá</p>
      <p><span className='text-highlighter'>Barva vlasů:</span> Světle hnědá</p>
      ...
      <h2>Vzhled a styl</h2>
      <hr/>
      <p>Luana nemá nijak výrazný styl oblékání, protože dává <span className="text-highlighter">přednost pohodlí a přirozenosti před jakýmkoliv vyumělkováním</span>.
          Ačkoliv je trochu menšího vzrůstu, <span className="text-highlighter">miluje pohyb</span> a na první pohled je
          na ní jasně vidět, že jí sport rozhodně není cizí a je velmi fyzicky aktivní. Jako <span
            className="text-highlighter">zvěromág</span> na sebe navíc dokáže brát podobu mladého ocelota. Její přeměny
          už bývají většinou povedené, ale ovládání zvířecího těla občas trochu pokulhává, takže v této formě působí
          jako poněkud neohrabaný kočičí puberťák.</p>

      <h2>Povaha</h2>
      <hr/>
      <p>Její <span className="text-highlighter">nálady jsou velmi proměnlivé</span> a občas připomíná tak trochu
          Jekylla a Hyda, nebo prostě jen <span className="text-highlighter">cáklou holku</span>. Dokáže být jako
          nezastavitelné torpédo, ale klidně se stane, že pak i několik dní nepromluví s živou duší. Miluje <span
            className="text-highlighter">hledání skrytých vzorců</span> a souvislostí naprosto ve všem, i tam, kde téměř
          jistě žádné nejsou. Analyzuje symbiózu rostlin, vztahy mezi zvířaty i to, proč vlastně ještě nikdo nezabil
          jejího bratra. Navenek toho na první dobrou moc neukáže, takže kdo ji chce skutečně poznat, musí si ji
          proklepnout sám.</p>

      <h2>Vztahy</h2>
      <hr/>
      <p>Co se týče komunikace, má docela <span className="text-highlighter">prořízlou pusu</span>. Paradoxně platí, že
          čím více si dává pozor na to, co před někým řekne, tím více jí na dané osobě záleží a váží si jejího názoru.
          Velmi <span className="text-highlighter">specifický vztah má se svým bratrem „Gabbym“</span>. I když by to
          nahlas přiznala jen naprosto výjimečně, má ho velmi ráda a je to její nejlepší kamarád. Váže se k němu ovšem i
          její největší zlozvyk, kterým je jeho <span className="text-highlighter">neustálé opravování</span>. Kdyby
          její bratr náhodou neslyšel, prozradila by, že místo <span className="text-highlighter">nejlepšího přítele by pak obsadili Alejandro Navarro</span> a <span
            className="text-highlighter">Inés Caro</span>, jelikož má jinak spoustu skvělých kamarádů.</p>

      <h2>Zájmy, studium a libůstky</h2>
      <hr/>
      <p>Má ráda <span className="text-highlighter">ticho</span>, <span className="text-highlighter">klid</span>, <span
        className="text-highlighter">květiny</span>, <span className="text-highlighter">citrusy</span> a <span
        className="text-highlighter">zvonohlídky</span>. Její velkou vášní a doslova závislostí je <span
        className="text-highlighter">oheň</span> a <span className="text-highlighter">noční obloha</span> plná hvězd. K
          jídlu si nejraději dává sýrové bochánky pao de queijo a nedá dopustit na <span className="text-highlighter">wayusový čaj</span>.
...
export default LuanaMarianaAlmeidaSoares