...
const InesSorayaCaro = () => (
  <div>
   ...
   <h2>Studium</h2>
    ...
    <p><span className='text-highlighter'>Vedlejší předměty:</span> V podstatě ji můžete potkat všude, ale hlavně se specializuje na aplikovanou magibotaniku, cizokrajné jedy a protijedy, přírodní magii a rituální magii</p>
