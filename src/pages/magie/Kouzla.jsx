...
const Kouzla = () => (
  <div>
    ...
    <p><i>„živé kořeny“</i><br/>
      ...
      <span className='text-highlighter'>Pohyb hůlkou:</span> spirálovité stočení hůlky směrem ke kořenům a trhnutí
      vpřed směrem k cíli.<br/>
      <span className='text-highlighter'>Efekt:</span> Kořeny reagují na vůli kouzelníka: mohou uvěznit nohy nepřítele,
      vytvořit překážku, improvizovaný most nebo ochrannou bariéru. Účinek závisí na představivosti a napojení na
      přírodu.</p>
    ...
    <p><i>„ochrana jedince“</i><br/>
      ...
      <span className='text-highlighter'>Efekt:</span> Vytvoří ochranný štít kolem vybrané osoby, který pohltí
      následující útok na ni směřovaný.</p>
    ...
    <p><i>„volání kořenů“</i><br/>
      ...
      <span className='text-highlighter'>Efekt:</span> Vysílá skrze půdu slabé vibrace, které vycvičený spojenec cítí
      jako pulz v chodidlech a podle jejich rytmu pozná směr i vzdálenost volajícího.</p>
    ...
    <p><i>„zelený dech/duše“</i><br/>
      ...
      <span className='text-highlighter'>Pohyb hůlkou:</span> Jemný půlkruh odspodu nahoru, zakončený lehkým nadechnutím
      při seslání (sesilatel často podvědomě následuje gestem svůj vlastní dech).<br/>
      <span className='text-highlighter'>Efekt:</span> Cíli se uvolní dýchací cesty a jeho plíce se naplní pocitem
      čerstvého lesního vzduchu. Účinek je pozvolný a dlouhodobý – zlepšuje průchodnost dýchacích cest a vitalitu při
      námaze.</p>
    ...
    <p><i>„zaostři“</i>
      ...
      <span className='text-highlighter'>Efekt:</span> Vybraný smysl se výrazně zesílí, zatímco ostatní se dočasně
      utlumí.<br/>
      <span className='text-highlighter'>Poznámka:</span> Přestimulování smyslu může způsobit dezorientaci, bolest nebo
      šok.</p>
    ...
    <p><i>„poselství listu“</i><br/>
      ...
      <span className='text-highlighter'>Pohyb hůlkou:</span> Namíření na chráněný papírek a jemné mávnutí před sebe
      jako rozproudění větru, který papírek unese k adresátovi.<br/>
      <span className='text-highlighter'>Efekt:</span> Kouzlo aktivuje papírek chráněný živluvzdornou magií. Pohybuje se
      k adresátovi, jehož jméno vyslovil a kterého si během sesílání představuje. Při doručení adresát slyší jemné
      „šustění“ a papírek se zastaví u jeho ruky.</p>
