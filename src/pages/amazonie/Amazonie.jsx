...
const Amazonie = () => (
  <div>
    ...
    <p>Samotný přístup k přírodě je pro místní taktéž velmi důležitý. Je velmi přirozená její ochrana, sounáležitost s ní nebo i <span className='text-highlighter'>maximální využití přírodních zdrojů bez zbytečného plýtvání</span> nebo ničení.</p>
