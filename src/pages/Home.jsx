...
const Home = () => (
  <div>
   ...
   <img src="https://i.postimg.cc/nVGJrZRz/cd7b5daa-bb0d-47b2-ae59-ad21f6130705.png" className='img-50' />
   ...
   <img src="https://i.postimg.cc/KcDNRcd6/ze-HTRO0x-Ontpl-Xz6p-BC3-1-pnv1q.jpg" className='img-30 img-margin-right-20' />
   <img src="https://i.postimg.cc/JnmXLZ4t/realistic-beautiful-amazon-rainforest-952161-1.jpg"  className='img-30 img-margin-left-20'  />
    ...
    <img src="https://i.postimg.cc/vBRhk3KL/N-vrh-bez-n-zvu.png" className='img-30 img-margin-right-20' />
    <img src="https://i.postimg.cc/hGVTzgCv/N-vrh-bez-n-zvu-1.png" className='img-30 img-margin-left-20' />
    ...
    <img src="https://i.postimg.cc/9f9KDR5b/N-vrh-bez-n-zvu-2.png" className='img-30 img-margin-right-20' />
    <img src="https://i.postimg.cc/0jzpNShk/N-vrh-bez-n-zvu-3.png" className='img-30 img-margin-left-20' />
